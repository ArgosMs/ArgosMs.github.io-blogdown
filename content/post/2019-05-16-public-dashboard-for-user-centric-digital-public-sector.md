---
title: Public dashboard for user-centric digital public sector
author: ArgosMs
date: '2019-03-28'
slug: public-dashboard-for-user-centric-digital-public-sector
categories:
  - dashboard
tags:
  - Governance
...
The outcome of this [exercise](https://argosms.shinyapps.io/City_Template_Dashboard/) is still very afar from all the possibilities that Shiny offers. However, I have really enjoyed this initial experiment mainly because this is the first app I created without knowing anything about `html` and also because I now share a bit of that satisfaction that my fellow webdesigners enjoy when building these cool things that get so much of our daily attention.
